...
try:
    ...
    (
        ...
        makhachHang INT,  -- Chỉ định kiểu dữ liệu cho cột INT
        FOREIGN KEY (makhachhang) REFERENCES KhachHang(makhachhang) ON DELETE CASCADE ON UPDATE CASCADE  -- Ràng buộc khóa ngoại cho cột makhachhang
    );''',
